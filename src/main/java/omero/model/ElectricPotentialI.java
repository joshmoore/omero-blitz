...
public class ElectricPotentialI extends ElectricPotential implements ModelBased {
    ...
    */
    ...
    public UnitsElectricPotential getUnit(com.zeroc.Ice.Current current) {
        return this.unit;
    }

    public void setUnit(UnitsElectricPotential unit, com.zeroc.Ice.Current current) {
        this.unit = unit;
    }
    ...
    public ElectricPotential copy(com.zeroc.Ice.Current ignore) {
